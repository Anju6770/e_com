...
import 'package:multi_ecommerce/pages/men_collection.dart';
import 'package:multi_ecommerce/pages/women/kids_collection.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: '/kids_collection', page: () => KidsCollection(),
          bindings: [FavControllerBinding(), CartControllerBinding()],
        ),
        GetPage(
          name: '/women/detail',
